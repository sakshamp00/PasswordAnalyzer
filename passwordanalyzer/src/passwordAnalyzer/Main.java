...
public class Main {
    public static void main(String[] args) {
        ...
        try { // ERROR HANDLING
            System.out.println("Would you like to type in your own password? (Y for Yes, N if you'd like the system to generate one for you)");
            ...
            System.out.println("Is the password strong enough? " + strengthChecker.isStrongEnough());
            ...
            System.out.print("Enter a password to validate: "); //yall can figure this part out because I'm not sure what you're planning here, idk if you want like a login system or what
            String inputPassword = scanner.nextLine();

            PasswordValidator validator = new PasswordValidator(newPassword, 20);
            String validationMessage = validator.validateForFrontend(inputPassword);
            System.out.println(validationMessage);

            System.out.println("Password Strength Level: " + validator.getPasswordStrengthLevel(inputPassword));
